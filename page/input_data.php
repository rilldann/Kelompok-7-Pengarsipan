          ...
          <div class="col-lg-8 mb-5">
           <div class="card">
               <div class="card-header">
                 <h4 class="card-heading text-center">Isi File</h4>
               </div>
              <div class="card-body">
 
                <form class="form-horizontal" id="fadd" method="POST" enctype="multipart/form-data">    
                 <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="mb-3">
                      <label class="mb-2">Masukkan File PDF</label>
                      <div class="input-group mb-3"><span class="input-group-text">pdf</span>
                        <input class="form-control" type="file" id="pdfFile" aria-label="-">
